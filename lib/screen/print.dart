...
// class _MyAppState extends State<printApp> {
//   String _info = "";
//   String _msj = '';
...
//     bytes += generator.text('DAY END SUMMARY (DD-MM-YYYY HH:MM AM/PM)',styles: PosStyles(align: PosAlign.center,bold: true,underline: true,height: PosTextSize.size2,width: PosTextSize.size2,));
//     bytes += generator.text('.................................................', styles: PosStyles(align: PosAlign.center));
//     bytes += generator.text('Slesperson : MUNEER M N                     Username : 1005', styles: PosStyles(align: PosAlign.left));
//     bytes += generator.text('Route : 206                                  Vehicle : B 001', styles: PosStyles(align: PosAlign.left));
//     bytes += generator.text('.................................................', styles: PosStyles(align: PosAlign.center));
//     // bytes += generator.text('Test data', styles: PosStyles(codeTable: 'CP1252'));

//     bytes += generator.text('Maraidemo', styles: PosStyles(bold: true));
//     bytes += generator.text('......................', styles: PosStyles(reverse: true));
//     bytes += generator.text('test', styles: PosStyles(underline: true), linesAfter: 1);
//     bytes += generator.text('Align left -test data', styles: PosStyles(align: PosAlign.left));
//     bytes += generator.text('Align center-test data', styles: PosStyles(align: PosAlign.center));
//     bytes += generator.text('test', styles: PosStyles(align: PosAlign.right), linesAfter: 1);
